...
3.	Write the Python code using the print() function.
4.	Right-click the file and select Run, or execute it using the terminal.
5.	Observe the output in the Run window or terminal.

Output
Hello, World!

Conclusion
The project was completed successfully. The program correctly prints the message “Hello, World!” to the console. This project provides a strong foundation for understanding basic Python programming concepts and serves as a starting point for more advanced coding tasks.
